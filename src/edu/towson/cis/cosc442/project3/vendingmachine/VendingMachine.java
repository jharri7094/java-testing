...
public class VendingMachine {
	...
	// Error message for invalid item
	...
	public void addItem(VendingMachineItem item, String code)
		...
		if(item == null){
			throw new VendingMachineException(INVALID_ITEM);
		}
	 ...
	 * Precondition: amount >= 0 or amount != -0
	 * Postcondition: balance is now the previous balance + amount.
	 * @param amount The amount of money to put in the vending machine
	 * @throws VendingMachineException Throws a VendingMachineException if amount is less than 0 
	 */
